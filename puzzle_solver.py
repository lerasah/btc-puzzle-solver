...
def notify(content, cfg, kind="status"):
    ...
    req = urllib.request.Request(url, data=body, headers={"Content-Type": "application/json", "User-Agent": "Mozilla/5.0 (compatible; puzzle-solver/1.0; +https://github.com/lerasah/btc-puzzle-solver)"})
    try:
